...
//
//  public AzBlobOutputStream(String key, AzBlobSinkConnectorConfig conf, CloudBlobClient blobClient, CloudBlobContainer azContainer) {
...
//
//    CloudBlockBlob blockBlobReference = azContainer.getBlockBlobReference(key);
//
